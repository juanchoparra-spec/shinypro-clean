          ...
          {!data && (
            <div>
              ...
              <select className="sp-input" value={repetir} onChange={e => setRepetir(e.target.value)}>
                ...
                <option value="2semanas">Cada 2 semanas (cada 14 días, por 1 año)</option>
                <option value="3semanas">Cada 3 semanas (cada 21 días, por 1 año)</option>
                <option value="mensual">Mensual (cada 28 días / 4 semanas, por 1 año)</option>
                <option value="anual_semanal">Semanal (cada 7 días, por 1 año)</option>
              </select>
              {repetir !== "ninguna" && (
